          ...
          <div className="mx-auto grid max-w-6xl gap-8 px-4 md:grid-cols-5 md:px-8">
            ...
            <div className="md:col-span-2">
              <div className="overflow-hidden bg-navy text-white">
                ...
                <div className="flex divide-x divide-white/10 border-t border-white/10 text-sm">
                  ...
                  <a href="https://pub-8b16770935a84226a2ce21554c7466de.r2.dev/site/iphone_mobile.png" target="_blank" rel="noopener noreferrer" className="flex flex-1 flex-col items-center gap-1 py-3.5 text-white/60 transition hover:bg-white/5 hover:text-white">
                    <span>📱</span><span>아이폰 문제</span>
                  </a>
                  <a href="/approval/donation" className="flex flex-1 flex-col items-center gap-1 py-3.5 text-white/60 transition hover:bg-white/5 hover:text-white">
            ...
            <div className="flex flex-col border-t border-neutral-200 pt-8 md:col-span-3 md:border-t-0 md:border-l md:pt-0 md:pl-8">
              ...
              <div className="mt-2 flex gap-2">
                <a href="kakaomap://route?ep=37.4553,127.0583&by=CAR" target="_blank" rel="noopener noreferrer"
                ...
                <a href="nmap://route/car?dlat=37.4553&dlng=127.0583&dname=다애교회&appname=alllovechurch" target="_blank" rel="noopener noreferrer"
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-neutral-200 bg-neutral-50 py-2.5 text-xs font-medium text-navy transition hover:border-navy/30">
